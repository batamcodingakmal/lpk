...
<div class="row">
   <div class="col-md-12 col-sm-12 ">
      <div class="x_panel">
         ...
         <div class="x_content">
            <br>
            <form action="<?=base_url()?>pencari_kerja/save" method="POST" id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">

              <input type="hidden" id="id" name="id" value="<?=$data_pencari_kerja->id?>">
               <div class="item form-group">
                  ...
                  <div class="col-md-6 col-sm-6 ">
                     ...
                     value="<?=$data_pencari_kerja->firstname?>">
               ...
               <div class="item form-group">
                  ...
                  <div class="col-md-6 col-sm-6 ">
                     ...
                     value="<?=$data_pencari_kerja->lastname?>">
               ...
               <div class="item form-group">
                  ...
                  <div class="col-md-6 col-sm-6 ">
                     ...
                     value="<?=$data_pencari_kerja->email?>">
                  </div>
               </div>
